    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("div", null,
            ...
            React.createElement("div", { className: "bg-[#A9A181] h-[1200px] text-white font-[Pacifico] flex-row text-center pt-[150px] text-[50px] border-b-[2px] border-white" },
                "discover our world",
                React.createElement("div", { className: "pt-[7%] flex-col justify-between px-14" },
            ...
            React.createElement("div", { className: "bg-[#A9A181] h-[1200px] text-white  font-[Pacifico] text-center pt-[150px] text-[50px] px-14 pt-[150px] border-b-[2px] border-white" },
                "most popular animals",
                React.createElement("div", { className: "flex flex-row justify-between h-[500px] mt-[200px] font-averia" },
                ...
                React.createElement(link_1["default"], { href: "/animals" },
                    React.createElement("p", { className: "text-white font-averia text-right mt-[28px] text-[25px]  drop-shadow-[4px_4px_4px_rgba(0,0,0,0.5)] rounded-[4px]" },
                        "ANIMALS ",
